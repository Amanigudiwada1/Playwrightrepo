...
var firstName = "Amani";
var This_is_a_very_long_name_variable = "Amani";
var lastName = "Dutta"; // CamelCase

// Naming Conventions (Cases) mostly used in js
// ============================================
...
// 2. PascalCase (standard for JS classes and constructors) mostly used in js
let UserProfile = "PascalCase";
let ShoppingCart = "class name style";


// 3. snake_case (underscore separated) mostly used in js
